...
const ContactSection = () => {
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-slate-950 relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[800px] h-[600px] sm:h-[800px] bg-primary-900/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="glass p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl border border-slate-800">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {contactLinks.map((link) => (
              ...
              >
                ...
                <h4 className="font-bold text-white text-base sm:text-lg mb-2 text-center sm:text-left">{link.label}</h4>
