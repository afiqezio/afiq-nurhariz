  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-800/50 border border-slate-700 text-xs font-semibold text-primary-400 mb-6 sm:mb-8 animate-bounce">
          <span className="w-2 h-2 rounded-full bg-primary-500"></span>
          Available for new opportunities
        </div>
        
        <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black tracking-tight mb-4 sm:mb-6 leading-tight px-2">
          Crafting the <br />
          <span className="gradient-text">Future of Tech</span>
        </h1>
        
        <p className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-slate-400 mb-8 sm:mb-10 leading-relaxed font-light px-4">
        ...
        <div className="mt-12 sm:mt-16 md:mt-20 flex flex-wrap justify-center gap-3 sm:gap-6 opacity-50 grayscale hover:grayscale-0 transition-all duration-700 px-4">
          <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs sm:text-sm">Full-Stack</span>
          <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs sm:text-sm">Mobile Developer</span>
          <span className="px-3 sm:px-4 py-1.5 sm:py-2 bg-slate-900 border border-slate-800 rounded-lg text-xs sm:text-sm">AI Engineer</span>
        </div>
      </div>
